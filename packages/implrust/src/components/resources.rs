...
pub(crate) fn FeaturedWidgets() -> Element {
    let widgets = vec![
        ...
        (
            ...
            "/learn/general/#blog-posts".to_string(),
        ),
        (
            ...
            "/learn/general/curated-list".to_string(),
        ),
        (
